...
start_datetime = ct - datetime.timedelta(2)
start_year = start_datetime.timetuple().tm_year
start_JD = start_datetime.timetuple().tm_yday
start_hour = 1
total_hours = 48
i_dir_year=int(start_year)
i_dir_day=int(start_JD)
i_dir_hour=int(start_hour)
...
#----------------------------------------------------------------------------#
        ...
        progresslines=[]
        with open(logdir+'UWI_GEO_data_log.csv', 'r') as readFile:    
        ...
        with open(logdir+'UWI_GEO_data_log.csv', 'w', newline='') as writeFile:
